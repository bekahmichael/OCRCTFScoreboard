    ...
    public function toFile($path)
    {
        ...
        if (isset($this->default['style'])) {
            ...
            if (isset($this->default['style']['vertical-align'])) {
                ...
                if ($this->default['style']['vertical-align'] === 'top') {
                    $styleArray['alignment'] = [
        ...
        foreach ($this->data as $sheetTitle => $rows) {
            ...
            foreach ($rows as $row_key => $row) {
                ...
                foreach ($row as $real_column_key => $column) {
                    ...
                    $objWorkSheet->setCellValue($cell_name, (isset($column['value']) ? $column['value'] : ''));
                    ...
                    if (isset($column['style'])) {
                        ...
                        if (isset($column['style']['vertical-align'])) {
                            ...
                            } else if ($column['style']['vertical-align'] === 'top') {
                                $objWorkSheet->getStyle($cell_name)->getAlignment()->setVertical(\PHPExcel_Style_Alignment::VERTICAL_TOP);
                            } else if ($column['style']['vertical-align'] === 'bottom') {
                                $objWorkSheet->getStyle($cell_name)->getAlignment()->setVertical(\PHPExcel_Style_Alignment::VERTICAL_BOTTOM);
                            }
                        }
