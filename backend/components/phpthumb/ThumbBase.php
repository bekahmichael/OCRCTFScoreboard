...
namespace app\components\phpthumb;
...
abstract class ThumbBase
{
     ...
     *
     * This is also where a fair amount of plugins magaic happens.  This magic method is called whenever an "undefined"
     * class method is called in code, and we use that to call an imported function.
     *
