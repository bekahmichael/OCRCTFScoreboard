...
class DownloadReportAction extends Action
{
    ...
    public function run($event_id)
    {
            ...
            foreach ($report_data['questions'] as $question) {
                ...
                if (array_key_exists($question['id'], $team['answers'])) {
                    ...
                    if ($team['answers'][$question['id']]['is_correct']) {
                        $is_correct = ['value' => 'True', 'style' => ['text-align' => 'left', 'color' => '#4CAF50', 'font-weight' => 'bold']];
                        ...
                        $is_correct = ['value' => 'False', 'style' => ['text-align' => 'left', 'color' => '#FF0000', 'font-weight' => 'bold']];
                    }
                } else {
        ...
        (new Array2Xslsx($sheats))->toDownload('All Teams Report - ' . $event->name . ' - ' . date('m-d-Y') . '.xlsx');
    }
